<?php
/** * Template Name: Análisis de Conversaciones IA (Herramientas)
 * v1.0 - Interfaz para la nueva herramienta de análisis.
 */
...
$my_agents = $wpdb->get_results( $wpdb->prepare( "SELECT id, name FROM {$agents_table} WHERE user_id = %d ORDER BY name ASC", $current_user_id ) );
        ...
        <div class="neo-ai-main-content">
            ...
            <main>
                <div class="agent-selector-bar">
                    <label for="analysis-agent-selector">Selecciona un Agente para Analizar:</label>
                    <select id="analysis-agent-selector">
                    ...
                    <button id="analyze-button" class="button button-primary" disabled>Analizar Conversaciones</button>
                </div>

                <div id="analysis-results-wrapper" class="form-section" style="display: none;">
                    <div id="analysis-spinner" class="spinner-wrapper" style="display: none;">
                        <span class="spinner is-active"></span>
                        <p>Analizando conversaciones, por favor espera...</p>
                    </div>
