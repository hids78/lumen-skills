<?php
/** * Template Name: Análisis de Comportamiento UX (Herramientas)
 * v1 - Plantilla para la herramienta de análisis de comportamiento UX.
 */
            ...
            <div class="neo-ai-main-content">
                <header class="neo-ai-page-header">
                    <div class="neo-ai-page-header-left">
                        ...
                        <h1>Análisis de Comportamiento de Experiencia de Usuario</h1>
                    </div>
