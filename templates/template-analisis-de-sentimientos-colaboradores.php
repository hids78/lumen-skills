<?php
/** * Template Name: Análisis de Sentimientos Colaboradores (Herramientas)
 * v1 - Plantilla para la herramienta de análisis de sentimientos de colaboradores.
 */
        ...
        <div class="neo-ai-dashboard-layout">
            ...
            <aside class="neo-ai-sidebar">
                ...
                <nav class="neo-ai-sidebar-nav">
                    ...
                    <div class="neo-ai-submenu-container">
                        <a href="#" class="nav-tab has-submenu <?php if (is_page_template('templates/template-analisis-de-sentimientos-colaboradores.php') ) echo 'nav-tab-active'; ?>">
                        ...
                        <div class="neo-ai-submenu">
                            ...
                            <a href="<?php echo esc_url(home_url('/analisis-de-sentimientos-colaboradores/')); ?>" class="nav-tab-submenu <?php if ( is_page_template('templates/template-analisis-de-sentimientos-colaboradores.php') ) echo 'nav-tab-active'; ?>">
            ...
            <div class="neo-ai-main-content">
                <header class="neo-ai-page-header">
                    <div class="neo-ai-page-header-left">
                        ...
                        <h1>Análisis de Sentimientos de Colaboradores</h1>
                    </div>
